...
Smartfarm is a lightweight, browser-based farm management tool built with HTML, Tailwind CSS, vanilla JavaScript, and localStorage.  
...
1. **Download** or clone the repository
   ...
   ```bash
   git clone https://emilioochieng.github.io/manage-farm/